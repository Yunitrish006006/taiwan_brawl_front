...
const double maxElixir = 10;
const double elixirPerSecond = 0.8;
const int leftTowerX = 50;
const int rightTowerX = 950;
const int leftDeployMax = 420;
const int rightDeployMin = 580;
const int minFieldProgress = 80;
const int maxFieldProgress = 920;
const int towerHp = 3000;
const int maxComboCards = 3;
const int lateralMin = 120;
const int lateralMax = 880;

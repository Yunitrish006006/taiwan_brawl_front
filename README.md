...
Taiwan Brawl 是一個以 Flutter 製作的跨平台前端，整合了社交、即時對戰與 Firebase Cloud Messaging 通知能力。  
目前這個 repo 主要負責：

- 使用者登入與個人資料
- 好友、私訊與通知體驗
- Royale 對戰大廳、牌組與戰場 UI
- Flutter Web 輸出與 Firebase Messaging service worker
...
目前聊天接收主流程仍以 polling 為主，FCM 主要負責背景通知提醒。  
